...
class ElectricFuneral(Scene):
    def construct(self):
        ...
        eq2 = MathTex(
            r"U = \frac{k q^2}{x} \left(1 + \frac{1}{\sqrt{2}}\right)", font_size=25
        ...
        eq3 = MathTex(
            r"U = \frac{k q^2}{x} \cdot \frac{\sqrt{2} + 1}{\sqrt{2}}", font_size=25
        ).next_to(eq2, DOWN)
        ...
        eq4 = MathTex(
            r"U = \left(\frac{k q^2}{x}\right)(4 + \sqrt{2})", font_size=25
        ).next_to(eq3, DOWN)
        ...
        kinetic = MathTex(
            r" = \frac{m \cdot v^2}{2}", font_size=25
        ).next_to(eq4, RIGHT)
        ...
        eq5 = MathTex(
            r"\frac{2k q^2}{x}(4 + \sqrt{2}) = m v^2", font_size=25
        ).next_to(eq4, DOWN)

        eq6 = MathTex(
            r"\frac{2k q^2}{m x}(4 + \sqrt{2}) = v^2", font_size=25
        ).next_to(eq5, DOWN)

        eq7 = MathTex(
            r"v = \sqrt{\frac{2k q^2}{m x}(4 + \sqrt{2})}", font_size=25
        ).next_to(eq6, DOWN)
